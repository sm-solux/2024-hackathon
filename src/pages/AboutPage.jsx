...
const PosterImage = styled.object`
    width: 100%;
    height: auto;
    display: block;
    object-fit: contain;
                ...
                <About style={{ padding: "0vw 10vw" }}>
                    ...
                    <DacosInfoContainer>
                        <GroupTextContainer>
                            ...
                            <DSContent style={{ width: "90%" }}>
                                DACOS는 숙명여대 소프트웨어학부의 최초 데이터 분석 동아리로, "Data Analysis Club of Sookmyung" 의 약자입니다. DACOS는 데이터 처리, 머신러닝, 딥러닝 등의 기술을 함께 학습하며, 데이터 분석에 대한 깊이 있는 논의와 협업을 위한 공간을 제공합니다.
                            </DSContent>
                        </GroupTextContainer>
                    </DacosInfoContainer>
                    ...
                    <SoluxInfoContainer style={{ marginBottom: "100px" }}>
                        <GroupTextContainer>
                            ...
                            <DSContent style={{ width: "90%" }}>
                                리눅스 학회에서 출발한 Sookmyung Linux, SOLUX는 더 다양한 분야에 도전합니다.
                            </DSContent>
                        </GroupTextContainer>
                    </SoluxInfoContainer>
                </About>
                ...
                <About>
                    <InfoContainer>
                        ...
                        <InfoTextContainer>
                            <InfoBoldText>DACOS X SOLUX 해커톤</InfoBoldText>
                            <DSContent>
                                DACOS X SOLUX 해커톤은 DACOS의 데이터 분석 능력과 SOLUX의 개발 능력을 결합하여 협력적 사고와 미래지향적 아이디어 창출을 목표로 하는 해커톤입니다.
                            </DSContent>
                        </InfoTextContainer>
                    </InfoContainer>
                    ...
                    <DacosInfoContainer>
                        <GroupTextContainer>
                            ...
                            <DSSubtitle>소프트웨어학부 데이터분석 학회</DSSubtitle>
                            <DSContent>
                                DACOS는 숙명여대 소프트웨어학부의 데이터 분석 동아리로, 데이터 처리 및 분석, 머신러닝, 딥러닝 등의 분야에서 활동하고 있습니다.
                            </DSContent>
                        </GroupTextContainer>
                    </DacosInfoContainer>
                    ...
                    <SoluxInfoContainer>
                        <GroupTextContainer>
                            ...
                            <DSSubtitle>소프트웨어학부 개발 동아리</DSSubtitle>
                            <DSContent>
                                SOLUX는 다양한 소프트웨어 개발 프로젝트를 진행하며, 개발 능력을 향상시키기 위한 다양한 활동을 하고 있습니다.
                            </DSContent>
                        </GroupTextContainer>
                    </SoluxInfoContainer>
                </About>
